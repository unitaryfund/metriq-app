    ...
    <div id='metriq-main-content' className='container'>
      <div className='row'>
        ...
        <div className='col-md-8 text-justify'>
          ...
          <br />
          <h2 className='text-center'>Joining the community</h2>
          <div>
            <p>
            ...
            <p>
              ...
              <a href='https://discord.com/invite/JqVGmpkP96'>
                <span className='icon-wrapper' data-name='discord'>
            ...
            <p>
              ...
              <a href='https://twitter.com/unitaryfund'>
                <span className=' icon-wrapper icon-fa icon-fa-brands' data-name='twitter'>
            ...
            &nbsp;and&nbsp;
              <a href='https://github.com/unitaryfund'>
                <span className=' icon-wrapper icon-fa icon-fa-brands' data-name='github'>
          ...
          <br />
          <h2 className='text-center'>Inclusion policy</h2>
          <div>
            <p>
          ...
          <br />
          <h2 className='text-center'>Downloading the data</h2>
          <div>
            <p>
