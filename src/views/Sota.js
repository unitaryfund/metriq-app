...
const Sota = (props) => {
  return (
    <div id='metriq-main-content'>
      ...
      <div className='row'>
        <div className='col-md-9 text-left'>
          <p>We are still in the <b>"noisy intermediate-scale quantum" (NISQ)</b> era of quantum computing: qubit count and quality remain too low for practical error correction schemes. Therefore, we must still use our "cleanest" subset of hardware qubits as our logical qubits, without error correction. <Link to={'/Platform/80'}><b>Quantinuum System Model H1-1</b></Link> has the highest quantum volume in the industry, equivalent to approximately <Link to={'/Submission/642'}><b>19 "algorithmic qubits,"</b></Link> without error correction.</p>
          ...
          <p>Proof-of-concept of <b>error correction</b> has been achieved up to a <b>coherence gain</b> multiplicative factor of about <Link to={'/Submission/463'}><b>5.1</b></Link>, meaning that these test systems achieved 5.1 times the coherence time of their hardware qubits.</p>
        </div>
      </div>
    </div>
  )
