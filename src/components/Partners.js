import agnostiqLogo from './../images/agnostiq_logo.png'
  ...
  return (
    <div className='row'>
      ...
      <div className='col-md-8 text-justify'>
        <h2 className='text-center'>Our Partners and Supporters</h2>
        <div>
          <p>
          ...
          <div className='text-center'>
            ...
            <a href='https://agnostiq.ai/'><img src={agnostiqLogo} alt='Agnostiq logo' className='logo-image' /></a>
